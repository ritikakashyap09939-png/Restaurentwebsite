            ...
            <div>
              ...
              <div className="mt-6">
                <button
                  ...
                  className="block w-full text-center border border-secondary text-secondary py-2 hover:bg-secondary hover:text-[#1a0f0f] transition-colors rounded-sm font-medium uppercase tracking-wide text-sm cursor-pointer"
                >
                  Book A Table
                </button>
              </div>
